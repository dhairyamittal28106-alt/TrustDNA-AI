...
import { BadgeCheck, BrainCircuit, FileText, Fingerprint, LayoutDashboard, LogOut, Mail, Radar, ScanSearch, ShieldAlert, ShieldCheck, SlidersHorizontal, UserRound, type LucideIcon } from "lucide-react";
